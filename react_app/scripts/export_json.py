...
DMS_OUTPUT = "./public/data/dms_actions.json"
...
def generate_dms_data():
    """Generate initial DMS actions data structure for JSON storage."""
    try:
        # Create empty DMS actions structure
        dms_data = {
            "actions": [],
        }
        ...
        logging.error(f"Eroare la generarea datelor DMS: {e}")
...
def extract_data_from_all_files():
    try:
        ...
        opp_data = extract_data(wb_main["Operational Losses"], 9, 11, 10, 45, 110)
